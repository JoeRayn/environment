  ...
  (with-current-buffer input-buffer
    (call-process-region (point-min) (point-max)
                         ...
                         nil "-l" (concat (number-to-string start-line) "-"
                                           (number-to-string end-line)) "--style" "{based_on_style: pep8, indent_width: 4, column_limit: 120, blank_line_before_nested_class_or_def: true, disable_ending_comma_heuristic: true}")))
